            ...
            <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
                ...
                <form onSubmit={handleAddItems} className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div className="">
                        ...
                        <div className="relative">
                            <input type="text" name="notes" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm  shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Enter the Notes" required />

                        </div>

                        <label className="mt-4 mb-2 block text-sm font-medium">Enter the Quantity</label>
                        <div className="relative">
                            <input type="number" name="quantity" className="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm  shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Enter the Quantity" required />

...

          {
            user ? <>
              <div class="relative inline-block">
                <img class="inline-block size-[38px] rounded-lg" src={user?.photoURL} alt="Image Description"/>
                  <span class="absolute top-0 end-0 block size-2.5 rounded-full transform -translate-y-1/2 translate-x-1/2 ring-2 ring-white bg-red-400 dark:ring-neutral-900"></span>
              </div>

...
const Contact = () => {
    ...
    <div className="container px-6 py-12 mx-auto">
        <div className="text-center">
            <p className="font-medium text-[#95d230] dark:text-blue-400">Contact us</p>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
            <motion.div className="flex flex-col items-center justify-center text-center" whileHover={{ scale: 1.1 }}
    whileTap={{ scale: 0.9 }}>
                <span className="p-3 text-[#f3f8ea] rounded-full bg-[#95d230] dark:bg-gray-800">
                ...
                <p className="mt-2 text-[#95d230] dark:text-blue-400">support@foodWave.com</p>
            </motion.div>
    ...
    whileTap={{ scale: 0.9 }}>
                ...
                <p className="mt-2 text-[#95d230] dark:text-blue-400">New yor, brokelyn bridge</p>
            </motion.div>
